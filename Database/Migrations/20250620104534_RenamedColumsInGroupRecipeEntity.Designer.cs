...
namespace meal_menu_api.Database.Migrations
{
    ...
    [Migration("20250620104534_RenamedColumsInGroupRecipeEntity")]
    partial class RenamedColumsInGroupRecipeEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Account.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Dinners.DinnerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Dinners.DinnerScheduleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Groups.GroupRecipeEntity", b =>
                {
                    ...
                    b.Property<string>("RecipeOwnerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("GroupId", "RecipeOwnerId");
            ...
            modelBuilder.Entity("meal_menu_api.Entities.ShoppingList.ShoppingListEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("meal_menu_api.Entities.ShoppingList.ShoppingListIngredientEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("meal_menu_api.Entities.Account.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Dinners.DinnerEntity", b =>
                {
                    b.HasOne("meal_menu_api.Entities.Dinners.DinnerScheduleEntity", "DinnerSchedule")
                        .WithMany("Dinners")
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Dinners.DinnerScheduleEntity", b =>
                {
                    b.HasOne("meal_menu_api.Entities.Account.AppUser", "User")
            ...
            modelBuilder.Entity("meal_menu_api.Entities.GroupInvitationEntity", b =>
                {
                    ...
                    b.HasOne("meal_menu_api.Entities.Account.AppUser", "InvitedByUser")
                        .WithMany()
                        .HasForeignKey("InvitedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("meal_menu_api.Entities.Account.AppUser", "InvitedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("meal_menu_api.Entities.Groups.GroupRecipeEntity", b =>
                {
                    b.HasOne("meal_menu_api.Entities.GroupEntity", null)
                        .WithMany("GroupRecipes")
                        .HasForeignKey("GroupEntityId");

                    b.HasOne("meal_menu_api.Entities.GroupMemberEntity", "RecipeOwner")
                        .WithMany("GroupMemberRecipes")
                        .HasForeignKey("GroupId", "RecipeOwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("meal_menu_api.Entities.ShoppingList.ShoppingListEntity", b =>
                {
                    b.HasOne("meal_menu_api.Entities.Dinners.DinnerScheduleEntity", "DinnerSchedule")
                        ...
                        .HasForeignKey("meal_menu_api.Entities.ShoppingList.ShoppingListEntity", "DinnerScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("meal_menu_api.Entities.ShoppingList.ShoppingListIngredientEntity", b =>
                {
                    b.HasOne("meal_menu_api.Entities.ShoppingList.ShoppingListEntity", "ShoppingList")
                        .WithMany("Ingredients")
            ...
            modelBuilder.Entity("meal_menu_api.Entities.GroupMemberEntity", b =>
                {
                    b.Navigation("GroupMemberRecipes");
                });
